...
What makes Ren dangerous is not her power — it is her certainty. She does not doubt. She does not hesitate. When she writes a word, reality adjusts to accommodate her spelling.`,
    ...
    keepsake: {
      id: 'frozen_quill',
      name: 'Frozen Quill',
      description: 'Freezes all enemy minions for 1.5 seconds, halting their attacks. Frequent disruption.',
      ...
      loyaltyTiers: [
        { level: 1, name: 'Acquainted', loyaltyRequired: 0, bonus: 'Base abilities unlocked', bonusType: 'effect_boost', bonusValue: 1.0 },
        { level: 2, name: 'Annotated', loyaltyRequired: 10, bonus: 'Cooldown reduced by 10%', bonusType: 'cooldown_reduction', bonusValue: 0.1 },
        { level: 3, name: 'Co-Author', loyaltyRequired: 25, bonus: 'Freeze duration +0.5s', bonusType: 'duration_boost', bonusValue: 0.5 },
        { level: 4, name: 'Archivist', loyaltyRequired: 50, bonus: 'Cooldown reduced by 20%', bonusType: 'cooldown_reduction', bonusValue: 0.2 },
        { level: 5, name: 'Icebound', loyaltyRequired: 100, bonus: 'Frozen enemies take 2x damage from next hit', bonusType: 'new_ability', bonusValue: 2.0 },
      ],
...
The classified incident in his dossier? He burned something that should not have been burnable. The Society still doesn't know how. Neither does he.`,
    ...
    modelComponent: 'ignis',
    color: '#ef4444',
    emissiveColor: '#dc2626',
    keepsake: {
      id: 'cinder_heart',
      name: 'Cinder Heart',
      description: 'Scorches all enemy minions with devastating burn damage over time. Rare but catastrophic.',
      ...
      loyaltyTiers: [
        { level: 1, name: 'Spark', loyaltyRequired: 0, bonus: 'Base abilities unlocked', bonusType: 'effect_boost', bonusValue: 1.0 },
        { level: 2, name: 'Kindling', loyaltyRequired: 10, bonus: 'Burn damage +25%', bonusType: 'effect_boost', bonusValue: 1.25 },
        { level: 3, name: 'Inferno', loyaltyRequired: 25, bonus: 'Burn duration +1.5s', bonusType: 'duration_boost', bonusValue: 1.5 },
        { level: 4, name: 'Wildfire', loyaltyRequired: 50, bonus: 'Cooldown reduced by 15%', bonusType: 'cooldown_reduction', bonusValue: 0.15 },
        { level: 5, name: 'Cinder Soul', loyaltyRequired: 100, bonus: 'Burns spread to adjacent enemies on kill', bonusType: 'new_ability', bonusValue: 1.0 },
      ],
    },
...
Her constructs grow from seeds she keeps in a locket around her neck. Each seed contains a complete organism, waiting. She whispers to them. They respond. The relationship between Morrigan and her creations is less like a mage and her weapons and more like a mother and her very, very dangerous children.`,
    ...
    keepsake: {
      id: 'spore_locket',
      name: 'Spore Locket',
      description: 'Releases a field-wide plague of toxic spores that poison ALL enemies. Rare but devastating.',
      ...
      loyaltyTiers: [
        { level: 1, name: 'Seedling', loyaltyRequired: 0, bonus: 'Base abilities unlocked', bonusType: 'effect_boost', bonusValue: 1.0 },
        { level: 2, name: 'Rooted', loyaltyRequired: 10, bonus: 'Poison damage +30%', bonusType: 'effect_boost', bonusValue: 1.3 },
        { level: 3, name: 'Entangled', loyaltyRequired: 25, bonus: 'Poison duration +2s', bonusType: 'duration_boost', bonusValue: 2.0 },
        { level: 4, name: 'Overgrown', loyaltyRequired: 50, bonus: 'Cooldown reduced by 20%', bonusType: 'cooldown_reduction', bonusValue: 0.2 },
        { level: 5, name: 'Blightmother', loyaltyRequired: 100, bonus: 'Poisoned enemies heal your HP on death', bonusType: 'new_ability', bonusValue: 5.0 },
      ],
    },
...
What makes Volta remarkable is not her power but her understanding. She doesn't just channel electricity; she comprehends it at a fundamental level. She hears the hum of electrons. She feels the potential in a charged capacitor like a held breath. To her, the entire world is a circuit waiting to be completed.`,
    ...
    keepsake: {
      id: 'static_coil',
      name: 'Static Coil',
      description: 'Unleashes chain lightning that zaps all enemy minions. Frequent, punishing jolts.',
      ...
      loyaltyTiers: [
        { level: 1, name: 'Grounded', loyaltyRequired: 0, bonus: 'Base abilities unlocked', bonusType: 'effect_boost', bonusValue: 1.0 },
        { level: 2, name: 'Charged', loyaltyRequired: 10, bonus: 'Cooldown reduced by 10%', bonusType: 'cooldown_reduction', bonusValue: 0.1 },
        { level: 3, name: 'Conducting', loyaltyRequired: 25, bonus: 'Shock damage +40%', bonusType: 'effect_boost', bonusValue: 1.4 },
        { level: 4, name: 'Overloaded', loyaltyRequired: 50, bonus: 'Shock duration +1s', bonusType: 'duration_boost', bonusValue: 1.0 },
        { level: 5, name: 'Lightning Rod', loyaltyRequired: 100, bonus: 'Chain lightning arcs to 2 additional targets', bonusType: 'new_ability', bonusValue: 2.0 },
      ],
    },
...
Orin does not build weapons. He builds shields. Walls. Barriers. Things that stand between the vulnerable and the threat. Every construct he creates is an act of protection. He lost something once — the details are in a file he asked to have sealed — and he has spent every day since making sure nothing else is lost on his watch.`,
    ...
    keepsake: {
      id: 'rusted_aegis',
      name: 'Rusted Aegis',
      description: 'Shields all allied minions, reducing incoming damage by 75%. Rare but clutch save.',
      ...
      loyaltyTiers: [
        { level: 1, name: 'Foundling', loyaltyRequired: 0, bonus: 'Base abilities unlocked', bonusType: 'effect_boost', bonusValue: 1.0 },
        { level: 2, name: 'Tempered', loyaltyRequired: 10, bonus: 'Shield duration +1s', bonusType: 'duration_boost', bonusValue: 1.0 },
        { level: 3, name: 'Forged', loyaltyRequired: 25, bonus: 'Damage reduction +10%', bonusType: 'effect_boost', bonusValue: 0.1 },
        { level: 4, name: 'Ironclad', loyaltyRequired: 50, bonus: 'Cooldown reduced by 15%', bonusType: 'cooldown_reduction', bonusValue: 0.15 },
        { level: 5, name: 'Immovable', loyaltyRequired: 100, bonus: 'Shielded allies reflect 25% damage to attackers', bonusType: 'new_ability', bonusValue: 0.25 },
      ],
    },
...
The loneliness is the hardest part. She can see what others cannot, hear what others cannot, perceive dimensions of reality that are invisible to everyone around her. It is isolating in a way that no amount of companionship can fix. She joined the Society because they were the first people who didn't look at her like she was broken. They looked at her like she was useful. She prefers useful to understood.`,
    ...
    keepsake: {
      ...
      description: 'Drains life from all enemy minions and heals your HP bar. Balanced and versatile.',
      ...
      loyaltyTiers: [
        { level: 1, name: 'Glimpsed', loyaltyRequired: 0, bonus: 'Base abilities unlocked', bonusType: 'effect_boost', bonusValue: 1.0 },
        { level: 2, name: 'Shadowed', loyaltyRequired: 10, bonus: 'Drain damage +25%', bonusType: 'effect_boost', bonusValue: 1.25 },
        { level: 3, name: 'Hollow', loyaltyRequired: 25, bonus: 'Heal amount +30%', bonusType: 'effect_boost', bonusValue: 1.3 },
        { level: 4, name: 'Abyssal', loyaltyRequired: 50, bonus: 'Cooldown reduced by 20%', bonusType: 'cooldown_reduction', bonusValue: 0.2 },
        { level: 5, name: 'Void-Touched', loyaltyRequired: 100, bonus: 'Drained enemies are slowed by 40% for 3s', bonusType: 'new_ability', bonusValue: 0.4 },
      ],
    },
...
His workshop is the warmest place in the Undercroft. Not temperature-warm — emotionally warm. His constructs purr. They follow him around like puppies. One of them — a transmuted kettle he calls "Duchess" — brings him tea at precisely 4pm every day. He insists she does it because she wants to, not because he programmed her. He may be right.`,
    ...
    arenaImagePath: '/assets/images/mages/lumi_the_gilded_alchemist_arena.png',
    color: '#d4af37',
    emissiveColor: '#b8972e',
    keepsake: {
      id: 'philosophers_thimble',
      name: "Philosopher's Thimble",
      description: 'Transmutes allied minions, tripling their attack power. Rare but game-changing.',
      ...
      loyaltyTiers: [
        { level: 1, name: 'Curious', loyaltyRequired: 0, bonus: 'Base abilities unlocked', bonusType: 'effect_boost', bonusValue: 1.0 },
        { level: 2, name: 'Apprentice', loyaltyRequired: 10, bonus: 'Buff duration +1s', bonusType: 'duration_boost', bonusValue: 1.0 },
        { level: 3, name: 'Artisan', loyaltyRequired: 25, bonus: 'Attack multiplier +0.5x', bonusType: 'effect_boost', bonusValue: 0.5 },
        { level: 4, name: 'Transmuter', loyaltyRequired: 50, bonus: 'Cooldown reduced by 15%', bonusType: 'cooldown_reduction', bonusValue: 0.15 },
        { level: 5, name: 'Gilded', loyaltyRequired: 100, bonus: 'Buffed allies gain a shield equal to 20% max HP', bonusType: 'new_ability', bonusValue: 0.2 },
      ],
    },
